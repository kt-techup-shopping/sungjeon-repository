...
public class Product extends BaseEntity {
	...
	public void update(
		...
		Preconditions.validate(Strings.isNotBlank(color), ErrorCode.INVALID_PARAMETER);
		Preconditions.validate(price >= 0, ErrorCode.INVALID_PARAMETER);
		Preconditions.validate(stock >= 0, ErrorCode.INVALID_STOCK_QUANTITY);
		Preconditions.validate(!(stock == 0 && status != ProductStatus.SOLD_OUT), ErrorCode.INVALID_PARAMETER);
