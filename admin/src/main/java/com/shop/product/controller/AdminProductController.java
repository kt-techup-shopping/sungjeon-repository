...
public class AdminProductController {
	...
	public ApiResult<AdminProductInfoResponse> createProduct(@RequestBody @Valid AdminProductCreateRequest request) {
	...
	public ApiResult<Page<AdminProductSearchResponse>> getProductSearchList(
	...
	@GetMapping("/{id}")
	@ResponseStatus(HttpStatus.OK)
	public ApiResult<AdminProductDetailResponse> getProductDetail(@PathVariable Long id) {
		return ApiResult.ok(adminProductService.getAdminDetail(id));
	}

	@Operation(summary = "상품 정보 수정", description = "관리자가 상품의 상세 정보를 수정합니다.")
	@PutMapping("/{id}")
	@ResponseStatus(HttpStatus.OK)
	public ApiResult<AdminProductInfoResponse> updateProduct(
		@PathVariable Long id,
		@RequestBody @Valid AdminProductUpdateRequest request
	) {
		var product = adminProductService.updateInfo(
			id,
			request.name(),
			request.price(),
			request.description(),
	...
	@Operation(summary = "상품 활성화", description = "관리자가 상품을 활성화합니다.")
	@PutMapping("/{id}/activate")
	@ResponseStatus(HttpStatus.OK)
	public ApiResult<AdminProductStatusResponse> updateActivated(
		@PathVariable Long id
	) {
		return ApiResult.ok(adminProductService.updateActivated(id));
	}

	@Operation(summary = "상품 비활성화", description = "관리자가 상품을 비활성화합니다.")
	@PutMapping("/{id}/in-activate")
	@ResponseStatus(HttpStatus.OK)
	public ApiResult<AdminProductStatusResponse> updateInActivated(
		@PathVariable Long id
	) {
	...
	@PutMapping("/{id}/sold-out-toggle")
	@ResponseStatus(HttpStatus.OK)
	public ApiResult<AdminProductStatusResponse> updateSoldOut(
		@PathVariable Long id
	) {
	...
	public ApiResult<List<AdminProductStatusResponse>> updateSoldOutList(
		@PathVariable Long id,
		@RequestBody @Valid AdminProductSoldOutRequest request
	) {
	...
	@GetMapping("/stock")
	@ResponseStatus(HttpStatus.OK)
	public ApiResult<Page<AdminProductStockResponse>> getStock(
		@RequestParam(required = false) String keyword,
		@ParameterObject Paging paging
	) {
	...
	@ResponseStatus(HttpStatus.OK)
	public ApiResult<AdminProductStatusResponse> deleteProduct(
		@PathVariable Long id
	) {
